...
| `frontend/lib/glazing.ts` | Glazed Walls & Glass Doors | **done** — Turns a real wall and its doors to glass, resolved wall → room → building. A material pass over the pieces the solver already cut, so doors and windows stay exactly where they were |
